      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="w-max ml-auto mt-6">
          <button
            ...
            className="bg-green1 rounded-lg py-2 px-6 transition-all delay-75 border-2 border-green1 hover:bg-transparent hover:text-green1 disabled:border-transparent disabled:bg-transparent disabled:text-[transparent]"
          >
            Enviar
          </button>
        </div>
